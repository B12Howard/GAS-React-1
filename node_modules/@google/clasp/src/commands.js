...
exports.push = function (cmd) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                _c.sent();
                return [4 /*yield*/, utils_1.validateManifest()];
            case 3:
                _c.sent();
                return [4 /*yield*/, utils_1.getProjectSettings()];
            case 4:
...
exports.clone = function (scriptId, versionNumber) { return __awaiter(_this, void 0, void 0, function () {
    var list_1, data, files_2, fileIds, answers, ids, files;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, utils_1.checkIfOnline()];
            case 1:
            ...
            case 6:
                files = _a.sent();
                return [4 /*yield*/, files_1.writeProjectFiles(files, '')];
            case 7:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.login = function (options) { return __awaiter(_this, void 0, void 0, function () {
    var isLocalLogin, loggedInLocal, loggedInGlobal, useLocalhost, oauthScopes, credsFile, credentials;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (isLocalLogin && loggedInLocal)
                    utils_1.logError(null, utils_1.ERROR.LOGGED_IN_LOCAL);
                if (!isLocalLogin && loggedInGlobal)
                    utils_1.logError(null, utils_1.ERROR.LOGGED_IN_GLOBAL);
                console.log(utils_1.LOG.LOGIN(isLocalLogin));
                return [4 /*yield*/, utils_1.checkIfOnline()];
            case 1:
                _a.sent();
                useLocalhost = !!options.localhost;
                if (!options.creds) return [3 /*break*/, 4];
...
exports.run = function (functionName, cmd) { return __awaiter(_this, void 0, void 0, function () {
    var localScript, scriptId, devMode, content, files, functionNames_1, answers, res, data, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, utils_1.checkIfOnline()];
            case 1:
            ...
            case 4:
                ...
                devMode = !cmd.nondev;
                if (!!functionName) return [3 /*break*/, 7];
            ...
            case 5:
                ...
                if (content.status !== 200) {
                    return [2 /*return*/, utils_1.logError(content.statusText)];
                }
                files = content.data.files || [];
                functionNames_1 = files
                ...
                return [4 /*yield*/, prompt([
                        {
                            ...
                            source: function (answers, input) {
                                ...
                                return new Promise(function (resolve) {
                                    ...
                                    var filtered = fuzzy.filter(input, functionNames_1);
...
exports.undeploy = function (deploymentId) { return __awaiter(_this, void 0, void 0, function () {
    var scriptId, deploymentsList, deployments_1, deployment;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, utils_1.checkIfOnline()];
            case 1:
            ...
            case 3:
                ...
                if (!scriptId)
                    return [2 /*return*/];
                if (!!deploymentId) return [3 /*break*/, 5];
...
exports.openCmd = function (scriptId, cmd) { return __awaiter(_this, void 0, void 0, function () {
    var deploymentsList, deployments, choices, answers;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, utils_1.checkIfOnline()];
            case 1:
...
exports.apis = function () { return __awaiter(_this, void 0, void 0, function () {
    var subcommand, serviceName, getProjectIdAndServiceURL, enableOrDisableAPI, command;
    var _this = this;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                getProjectIdAndServiceURL = function () { return __awaiter(_this, void 0, void 0, function () {
                    var serviceURL, projectId;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!serviceName) {
                                ...
                                serviceURL = serviceName + ".googleapis.com";
                                return [4 /*yield*/, utils_1.getProjectId()];
                            case 1:
                                projectId = _a.sent();
                                if (!projectId)
                                    throw utils_1.logError(null, utils_1.ERROR.NO_GCLOUD_PROJECT);
                                return [2 /*return*/, [projectId, serviceURL]];
                        }
                    });
                }); };
                enableOrDisableAPI = function (enable) { return __awaiter(_this, void 0, void 0, function () {
                    var _a, projectId, serviceURL, name, e_1;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, getProjectIdAndServiceURL()];
                            case 1:
                                _a = _b.sent(), projectId = _a[0], serviceURL = _a[1];
...
exports.setting = function (settingKey, settingValue) { return __awaiter(_this, void 0, void 0, function () {
    var currentSettings, keyValue, currentSettings, currentValue, scriptId, rootDir, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                if (settingKey in currentSettings) {
                    ...
                    utils_1.logError(null, "Unknown key \"" + settingKey + "\"");
                }
                return [3 /*break*/, 7];
            case 2:
                // Set specified key to the specified value
                if (settingKey !== 'scriptId' && settingKey !== 'rootDir') {
                    utils_1.logError(null, "Setting \"" + settingKey + "\" is unsupported");
                }
                _a.label = 3;
            case 3:
                _a.trys.push([3, 6, , 7]);
            ...
            case 4:
                ...
                scriptId = settingKey === 'scriptId' ? settingValue : currentSettings.scriptId;
                rootDir = settingKey === 'rootDir' ? settingValue : currentSettings.rootDir;
                return [4 /*yield*/, utils_1.saveProject(scriptId, rootDir)];
            case 5:
                _a.sent();
