...
function authorize(options) {
    return __awaiter(this, void 0, void 0, function () {
        var creds, oAuth2ClientOptions, localOAuth2ClientOptions, globalOauth2ClientOptions, token, claspToken, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    creds = options.creds;
                ...
                case 1:
                    ...
                    oauth2ClientAuthUrlOpts.scope = oauth2ClientAuthUrlOpts.scope.concat((options.additionalScopes || []));
                ...
                case 5:
                    ...
                    _a.label = 6;
                case 6:
                    console.log(utils_1.LOG.SAVED_CREDS(!!creds));
                    return [3 /*break*/, 8];
                case 7:
                    err_1 = _a.sent();
 ...
 */
function authorizeWithLocalhost(oAuth2ClientOptions) {
    return __awaiter(this, void 0, void 0, function () {
 ...
 * @param {OAuth2ClientOptions} oAuth2ClientOptions The required client options for auth.
 */
function authorizeWithoutLocalhost(oAuth2ClientOptions) {
    return __awaiter(this, void 0, void 0, function () {
