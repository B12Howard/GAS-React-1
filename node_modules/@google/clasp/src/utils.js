...
exports.hasOauthClientSettings = function (local) {
    ...
    return local ? fs.existsSync(dotfile_1.DOT.RC.ABSOLUTE_LOCAL_PATH) : fs.existsSync(dotfile_1.DOT.RC.ABSOLUTE_PATH);
};
/**
...
function getOAuthSettings() {
    return dotfile_1.DOTFILE.RC_LOCAL()
        .read()
        .then(function (rc) { return rc; })
        .catch(function (err) {
        return dotfile_1.DOTFILE.RC.read()
            .then(function (rc) { return rc; })
            .catch(function (err) {
...
exports.ERROR = {
    ...
    SCRIPT_ID: '\n> Did you provide the correct scriptId?\n',
    SETTINGS_DNE: "\nNo " + dotfile_1.DOT.PROJECT.PATH + " settings found. `create` or `clone` a project first.",
...
exports.LOG = {
    ...
    CREATE_DRIVE_FILE_FINISH: function (filetype, fileid) {
        return "Created new " + (getFileTypeName(filetype) || '(unknown type)') + ": " + exports.URL.DRIVE(fileid);
    },
    ...
    CREATE_PROJECT_FINISH: function (filetype, scriptId) {
        return "Created new " + getScriptTypeName(filetype) + " script: " + exports.URL.SCRIPT(scriptId);
    },
    ...
    CREDS_FROM_PROJECT: function (projectId) { return exports.URL.CREDS(projectId) + "\n"; },
...
function saveProject(scriptId, rootDir) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, dotfile_1.DOTFILE.PROJECT().write(project)];
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    manifest = fs.readFileSync(path.join(rootDir, exports.PROJECT_MANIFEST_FILENAME), 'utf8');
                    try {
                        JSON.parse(manifest);
                    }
                    catch (err) {
                        exports.logError(err, exports.ERROR.BAD_MANIFEST);
